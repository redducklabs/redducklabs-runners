...
# Kubernetes cluster configuration for redducklabs
...
echo "Deploying GitHub Actions Runner Controller for redducklabs..."
...
if [ $? -eq 0 ]; then
    ...
    echo "  curl -H \"Authorization: token \$GITHUB_TOKEN\" https://api.github.com/orgs/redducklabs/actions/runners"
    echo ""
    echo "To use in workflows:"
    echo "  runs-on: redducklabs-runners"
else
